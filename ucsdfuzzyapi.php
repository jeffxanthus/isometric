...
$key = $_POST['k'];
$quarter = $_POST['q'];
$course = str_replace(chr(13) . chr(10), chr(10), $_POST['c']);
$course = str_replace(chr(13), chr(10), $course);
...
function getVars($htmlstr, $infoLen){
    ...
    foreach($html->find('tr') as $e){
        ...
        return array("section"=>$section, "sectionID"=>$sectionID, "prof"=>$prof, "meetingType"=>$meetingType, "days"=>$days, "startTime"=>$startTime, "endTime"=>$endTime, "building"=>$building, "room"=>$room, "remainingSeats" => 'NaN', "totalSeats" => 'NaN');
    }
}
