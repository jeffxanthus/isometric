                                ...
                                if (nowElement[k]['days'] != 'TBA'){
                                    ...
                                    for (l = 0; l < daysArray.length; l++){
                                        ...
                                        if (nowElement[k]['meetingType'] != 'MI' && nowElement[k]['meetingType'] != 'FI'){
                                            tempInfoArray['description'] = nowElement['coursenumber'] + '\n' + nowElement[k]['meetingType'] + '\nSection ID: ' + nowElement[k]['sectionID'] + '\nSection: ' + nowElement[k]['section'] + '\nLocation: ' + nowElement[k]['building'] + ' ' + nowElement[k]['room'] + '\nProf: ' + nowElement[k]['prof'];
                                            tempClassInfoArray['class'].push(tempInfoArray);
                                        }else if(nowElement[k]['meetingType'] == 'MI'){
                                            tempInfoArray['description'] = nowElement['coursenumber'] + '\n' + nowElement[k]['meetingType'] + '\nDate: ' + nowElement[k]['section'] + '\nLocation: ' + nowElement[k]['building'] + ' ' + nowElement[k]['room'];
